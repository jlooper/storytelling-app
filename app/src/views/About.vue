  ...
  <main class="column is-four-fifths main is-pulled-right">
    <div class="main-content">
      ...
      <p>
        ...
        platform where curators can design online expositions and discover new
        art and design elements across many museum APIs. Currently the Cooper
        Hewitt and Victoria and Albert APIs are concurrently searchable.
      </p>
    </div>
  </main>
</template>
